...
export const Icon: React.FC<IconProps> = ({
  ...
  <div className={twMerge("relative shrink-0", wrapperClassName)}>
    ...
    {name === "instagram" && (
      <Instagram {...rest} className={twMerge(baseClasses, className)} />
    )}
    {name === "tiktok" && (
      <TikTok {...rest} className={twMerge(baseClasses, className)} />
    )}
    {name === "facebook" && (
      <Facebook {...rest} className={twMerge(baseClasses, className)} />
    )}
    {name === "pinterest" && (
      <Pinterest {...rest} className={twMerge(baseClasses, className)} />
    )}
  </div>
)
