...
export const CollectionsSection: React.FC<{ className?: string; locale: string }> = async ({
  className,
  locale,
}) => {
  ...
  return (
    <Carousel
      heading={<h3 className="font-cinzel font-normal text-md md:text-2xl">{t('collectionsTitle')}</h3>}
      button={
        <>
          <LocalizedButtonLink
            href="/store"
